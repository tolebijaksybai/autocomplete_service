...
return [
    ...
    'attributes'           => [
        ...
        'icon'                  => 'Иконка',
        'icon_size'             => 'Иконка (Макс: :size Мб)',
        'link'                  => 'Ссылка',
        'cookie_text'           => 'Текст cookie',
        'email_icon'            => 'Электронаая почта иконка',
        'phone_icon'            => ' Телефон иконка ',
        'created_at'            => 'Дата регистрации',
        'fio'                   => 'ФИО',
        'image'                 => 'Изображение',
        'image_size'            => 'Изображение (Макс: :size Мб)',
        'image_desktop_size'    => 'Изображение Desktop (Макс: :size Мб)',
        'image_mobile_size'     => 'Изображение Mobile (Макс: :size Мб)',
